"""
Sub-package for processing text as token sequences in labelled documents. A set of documents is represented as *corpus*
...
from ._corpusfuncs import (
    ...
    corpus_num_tokens, vocabulary_size, tokens_datatable, tokens_dataframe, print_summary, vocabulary_counts,
    ...
    corpus_summary, corpus_num_chars, tokens_with_pos_tags, filter_tokens_with_kwic, filter_documents_by_label,
